 ...
 */
@Entity
@NamedQuery(name = "findAllNative", query = "from Machine") 
@NamedNativeQuery(name = "findMachinesBySalle", query = "select * FROM machine WHERE salle_id = :salleId", resultClass = Machine.class)
